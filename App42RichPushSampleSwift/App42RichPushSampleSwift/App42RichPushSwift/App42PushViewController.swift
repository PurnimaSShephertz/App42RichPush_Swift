...
//        richPushManager.htmlString = richPushManager.htmlString?.addingPercentEncoding(withAllowedCharacters: .urlHostAllowed)
...
//        webView.loadRequest(urlRequest)
        webView.loadHTMLString(richPushManager.htmlString!, baseURL: nil);
    }
